...
export default function CustomizePage({ onOpenCustomerDashboard }) {
  ...
  // Active DM Chat view after submission or for active inquiries
  ...
  // Sync customer details when user logs in
    ...
    <section id="customize" className="customize-section">
      <div className="wrap">
        <div className="section-head">
          ...
          <h2>Studio Custom Orders &amp; Private DM</h2>
          <p>
            Have a dream craft in mind? Share your inspiration, customized text, or sketches.
            Our artisans will discuss with you over a private DM thread and send you a handcrafted price quote!
          </p>
        </div>

        {activeCustomOrder ? (
          /* Live Private DM Chat Portal */
          <div className="custom-chat-portal">
            <div className="chat-portal-header">
              <div>
                <span className="badge">Order ID: {activeCustomOrder.customOrderId}</span>
                <h3>Custom {activeCustomOrder.category} Inquiry</h3>
              ...
              <div className="portal-actions">
                ...
                {onOpenCustomerDashboard && (
                  <button className="btn btn-primary" onClick={onOpenCustomerDashboard}>
            ...
            {/* Quote Card Notification Banner if Quoted */}
          ...
          <div className="customize-builder-card">
